            ...
            for event in pygame.event.get():
                ...
                if event.type == KEYDOWN:
                    ...
                    if op is "":
                        op=str(event.key)
                    if op == "1":
                        self.update_card(tela,"cartas/zap.png")
                        carta_selecionada = "cartas/zap.png"
                    if op == "2":
                        self.update_card(tela,"cartas/7_of_diamonds.png")
                        carta_selecionada = "cartas/7_of_diamonds.png"
                    if op == "3":
                        self.update_card(tela,"cartas/king_of_hearts2.png")
                        carta_selecionada = "cartas/king_of_hearts2.png"
                    if op == "273":
                        print "carta jogada"
                        if (carta_selecionada != ""):
                            self.jogar_carta(tela,carta_selecionada)
